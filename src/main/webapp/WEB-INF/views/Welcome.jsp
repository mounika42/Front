...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="item active">
      ...
      src=C:\Users\admin\Pictures\Downloads\down.jsp style="width:100%" "height="50%">
    </div>
    <div class="item">
    <img class="img-rounded" class="img-responsive center-block"
      src=C:\Users\admin\Pictures\Downloads\images.jsp style="width:100%" "height="20%">
    </div>

    <div class="item">
    <img class="img-rounded" class="img-responsive center-block"
      src=C:\Users\admin\Pictures\Downloads\download.jsp style="width:100%" "height="50%">
    </div>
