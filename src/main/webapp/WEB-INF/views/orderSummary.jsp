        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li><a href="http://localhost:8080/CosmeticFrontend/">HOME</a></li>
                    <li><a href="http://localhost:8080/CosmeticFrontend/registration"></a></li>
                    <li class="">
  ...
  <div class="row">
	 ...
	 <thead>
		...
		<tbody>
			...
			<div class="media">
			 <a class="thumbnail pull-left" href=""><img class="media-object" src="/CosmeticFrontend/myImage/imageDisplay?id=${cart.productId}" class="img-thumbnail" width="72px" height="72px"/></a>
